...
public abstract class SelectionLayout<T> {
    ...
    protected final SelectionList<T> list;
    protected int rollX, rollY;
    protected int canvasWidth, canvasHeight;

    public SelectionLayout(SelectionList<T> list) {
        this.list = list;
    }
    ...
    public SelectionList<T> getList() {
        return list;
    }

    public <LIST extends SelectionList<T>> LIST getListAs() {
        return (LIST) list;
    }
