...
public class SCANetworks {
    ...
    public static void setup() {
        ...
        INSTANCE.registerMessage(nextID(), DrawSaveC2SPacket.class, DrawSaveC2SPacket::serialize, DrawSaveC2SPacket::new, DrawSaveC2SPacket::handle);
        INSTANCE.registerMessage(nextID(), SaveFailedS2CPacket.class, SaveFailedS2CPacket::serialize, SaveFailedS2CPacket::new, SaveFailedS2CPacket::handle);
        INSTANCE.registerMessage(nextID(), SaveSuccessS2CClient.class, SaveSuccessS2CClient::serialize, SaveSuccessS2CClient::new, SaveSuccessS2CClient::handle);
    }
